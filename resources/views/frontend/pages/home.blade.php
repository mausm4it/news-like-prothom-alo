            ...
            <div class="container-fluid home_page_part_one">
                <div class="home_page_part_one_left home_page_part_one_left_left_flex">
                                        ...
                                        @if ($images != '')
                                            @foreach ($images as $image)
                                                @if (File::exists($image))
                                                    ...
                                                    <h2 class="title ml-2 fs-4"> <a
                                                            href="@if ($top_news->news_categoryslug) {{ route(strtolower($top_news->news_categoryslug) . '.details', ['id' => $top_news->id, 'slug' => \Illuminate\Support\Str::slug($top_news->title)]) }} @endif">
                                                            {{ \Illuminate\Support\Str::limit($top_news->title, 60) }}</a>
                                                    </h2>
                                                @endif
                                            @endforeach
                                        @endif
                    ...
                    <div class="home_page_part_one_left_right home_page_pat_one_left_right_grid">
                        ...
                        @if ($top_sliding_news1->isNotEmpty())

                            @foreach ($top_sliding_news1 as $top_sliding_news)
                                @php
                                ...
                                <div class="leatest_three_post">
                                    ...
                                    @if ($top_sliding_news->news_categoryslug) @if (Route::has(strtolower($top_sliding_news->news_categoryslug)))
                                        ...
                                        @endif
                                            ">
                                                    <img class="img-fluid" width="500" height="280" src="{{ asset($image) }}"
                                                        alt="{{ asset($image) }}">

                                                </a>
                                                <h2 class="title ml-2 fs-2 font-weight-bold"> <a
                        ...
                        @if ($down_sliding_news2->isNotEmpty())

                        @foreach ($down_sliding_news2 as $top_sliding_news)
                            @php
                                $images = json_decode($top_sliding_news->image);
                            @endphp
                            <div class="leatest_three_post">
                                            ...
                                            @if (File::exists($image))
                                                <a class="home_sidebar_posts"
                                                    ...
                                                    <div class="flex_inner">
                                                        <h2 class="title ml-2 fs-4"> <a
                                                                href="@if ($top_rightside_news->news_categoryslug) {{ route(strtolower($top_rightside_news->news_categoryslug) . '.details', ['id' => $top_rightside_news->id, 'slug' => \Illuminate\Support\Str::slug($top_rightside_news->title)]) }} @endif"><b>
                                                                    {{ \Illuminate\Support\Str::limit($top_rightside_news->title, 40) }}
                                                                </b></a>
                                                        </h2>
                                    ...
                                    @if ($images != '')
                                        @foreach ($images as $image)
                                            @if (File::exists($image))
                                                ...
                                                <h2 class="title font-weight-bold fs-4"> <a
                                            ...
                                            @if ($images != '')
                                                @foreach ($images as $image)
                                                    @if (File::exists($image))
                                                        ...
                                                        <p class="title ml-2 fs-4"> <a
                                                                href="@if ($latestnews->news_categoryslug) {{ route(strtolower($latestnews->news_categoryslug) . '.details', ['id' => $latestnews->id, 'slug' => \Illuminate\Support\Str::slug($latestnews->title)]) }} @endif"><b>
                                                                    {{ \Illuminate\Support\Str::limit($latestnews->title, 60) }}
                                                                </b></a>
                                                        </p>
                                                        </a>
                                                    @endif
                                            ...
                                            @if ($images != '')
                                                @foreach ($images as $image)
                                                    @if (File::exists($image))
                                                        ...
                                                        <p class="title ml-2 fs-4"> <a
                                                                href="@if ($popularnews->news_categoryslug) {{ route(strtolower($popularnews->news_categoryslug) . '.details', ['id' => $popularnews->id, 'slug' => \Illuminate\Support\Str::slug($popularnews->title)]) }} @endif"><b>
                                                                    {{ \Illuminate\Support\Str::limit($popularnews->title, 60) }}
                                                                </b></a>
                                                        </p>
                                                        </a>
                                                    @endif
                                        ...
                                        @foreach ($images as $image)
                                            <ul class="single_right_item">
                                                <a class="home_second_part_grid"
                                                    ...
                                                    <li class="tab_post ml-2 font-weight-bold fs-4">{{ $catpost1->title }}
                                                    </li>
                                                </a>
                                            </ul>
                                        @endforeach
                        ...
                        <ul class="leatest_in_a_cat_postlopp">
                            ...
                            @if ($category_id1_post7 != '' && $category_id1_post7 != null)
                                ...
                                @foreach ($category_id1_post7 as $catpost7)
                                    <ul class="single_right_item">
                                        <li class="tab_post ml-2 font-weight-bold fs-4"><a
                                                ...
                                                <div class="col-12 col-md-6 col-lg-6 col-xl-12 box-news">
                                                    <a href="@if ($catpost2->news_categoryslug) {{ route(strtolower($catpost2->news_categoryslug) . '.details', ['id' => $catpost2->id, 'slug' => \Illuminate\Support\Str::slug($catpost2->title)]) }} @endif"
                                                        ...
                                                        <img width="500" height="280" src="{{ asset($image) }}"
                                                            class="attachment-custom-size size-custom-size wp-post-image"
                                                            alt="{{ $catpost2->title }}" />
                                                        <h2 class="title font-weight-bold fs-4">{{ $catpost2->title }}
                                                        </h2>
                                                    </a>
                                                </div>
                                            @endforeach
                                            ...
                                            <ul class="single_right_item">
                                                <a class="home_second_part_grid"
                                                    ...
                                                    <img width="500" height="280" src="{{ asset($image) }}"
                                                        class="attachment-custom-size size-custom-size wp-post-image"
                                                        alt="{{ \Illuminate\Support\Str::slug($catpost1->title) }}" />
                                                    <li class="tab_post ml-2 font-weight-bold fs-4">
                                                        {{ $catpost1->title }}</li>
                                                </a>
                                            </ul>
                                        @endforeach
